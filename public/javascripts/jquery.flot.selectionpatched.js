/* PATCHED VERSION!!!!
 ...
 This is a patched version of the original jquery.flot.selection.js plugin.

 This patch adds the ability to move/pan an allready existing selection.

 I found this patch in the old mailing list of flot: https://code.google.com/p/flot/issues/detail?id=486

 The original author of the patch is 'Matt' https://code.google.com/u/116957745807549683724/
    ...
    function init(plot) {
        ...
        function updateSelection(pos) {
            if (pos.pageX == null)
                ...
                offsetBorderSelection({
                    pageX: pos.pageX - selection.mousePos.pageX,
